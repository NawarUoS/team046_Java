...
public class DatabaseConnectionHandler {
    private static final String DB_URL = "jdbc:mysql://stusql.dcs.shef.ac" +
            ".uk:3306/team046";
    private static final String DB_USER = "team046";
    private static final String DB_PASSWORD = "du9meeSha";
